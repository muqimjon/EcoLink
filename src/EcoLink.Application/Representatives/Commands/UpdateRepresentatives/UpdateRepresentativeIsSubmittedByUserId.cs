...
public class UpdateRepresentativeIsSubmittedCommandByUserHandler(IRepository<Representative> repository, IMapper mapper) : 
    IRequestHandler<UpdateRepresentativeIsSubmittedByUserCommand, int>
{
