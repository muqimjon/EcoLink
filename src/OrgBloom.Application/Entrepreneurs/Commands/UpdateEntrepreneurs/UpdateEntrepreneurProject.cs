...
public class UpdateEntrepreneurProjectCommandHandler(IRepository<Entrepreneur> repository, IMapper mapper) : IRequestHandler<UpdateEntrepreneurProjectByUserIdCommand, int>
{
