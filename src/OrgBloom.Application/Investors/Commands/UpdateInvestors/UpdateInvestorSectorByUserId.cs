...
public class UpdateInvestorSectorByUserIdCommandHandler(IRepository<Investor> repository, IMapper mapper) : IRequestHandler<UpdateInvestorSectorByUserIdCommand, int>
{
