...
public class GetRepresentativePurposeByUserIdQueryHendler(IRepository<Representative> repository) : 
    IRequestHandler<GetRepresentativePurposeByUserIdQuery, string>
{
