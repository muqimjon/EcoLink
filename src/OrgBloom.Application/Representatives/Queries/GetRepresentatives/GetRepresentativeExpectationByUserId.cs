...
public class GetRepresentativeExpectationByUserIdQueryHendler(IRepository<Representative> repository) : 
    IRequestHandler<GetRepresentativeExpectationByUserIdQuery, string>
{
