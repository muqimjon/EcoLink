...
{
    private async Task SendInvestmentMenuAsync(ITelegramBotClient botClient, Message message, CancellationToken cancellationToken)
    {
        ...
        await botClient.SendTextMessageAsync(
            ...
            text: localizer["txtInvestmentMenu"],
